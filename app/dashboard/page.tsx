...
import { User, Settings, Bell, TrendingUp, Home, LogOut } from 'lucide-react';
...
export default function Dashboard() {
  ...
  // Admin users are redirected above, so this is only for regular users
  return (
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                  <div className="bg-white overflow-hidden shadow rounded-lg p-6">
                    ...
                    <div className="text-center">
                      <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center mx-auto mb-4 text-black font-bold text-xl border-2 border-gray-300">
            ...
            {activeSection === 'quick-actions' && (
              <div className="bg-white shadow rounded-lg p-6 max-w-md">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Quick Actions</h3>
                <div className="space-y-3">
                  <button className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 gap-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-900 mb-1">Oil Prices Reach 6-Month High</h4>
                        <p className="text-sm text-gray-600 mb-2">Global supply concerns push crude oil prices to their highest level since March.</p>
                        <div className="flex items-center gap-4 text-xs text-gray-500">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-900 mb-1">Cryptocurrency Market Shows Signs of Recovery</h4>
                        <p className="text-sm text-gray-600 mb-2">Bitcoin and major altcoins gain momentum as institutional adoption increases.</p>
                        <div className="flex items-center gap-4 text-xs text-gray-500">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-900 mb-1">Trade Tensions Escalate Between Major Economies</h4>
                        <p className="text-sm text-gray-600 mb-2">New tariffs announced, potentially impacting global supply chains and market stability.</p>
                        <div className="flex items-center gap-4 text-xs text-gray-500">
