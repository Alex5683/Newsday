    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 p-8">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-50 transition-colors"
              >
          ...
          {/* Right Panel - Switch Panel */}
          <div className="flex-1 bg-blue-600 p-8 text-white flex flex-col justify-center items-center lg:rounded-r-2xl">
